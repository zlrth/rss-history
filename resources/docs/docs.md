...
#### Why are are you seeing this page?

The `home-routes` handler in the `rss-history.routes.home` namespace
...
The `home-page` function will in turn call the `rss-history.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/rss_history/core.cljs` file.



#### Organizing the routes

The routes are aggregated and wrapped with middleware in the `rss-history.handler` namespace:
...
Request middleware functions are located under the `rss-history.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `rss-history.dev-middleware` namespace found in
